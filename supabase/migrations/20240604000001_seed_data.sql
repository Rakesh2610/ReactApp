...
VALUES 
  ...
  ('dessert-3', 'Ice Cream', 'Vanilla ice cream with chocolate sauce', 5.99, 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=500&q=80', 'desserts', true, false, false, false),
  ...
  ('sandwich-2', 'Veggie Sandwich', 'Grilled vegetables with hummus on whole grain bread', 9.99, 'https://images.unsplash.com/photo-1540914124281-342587941389?w=500&q=80', 'sandwiches', true, true, false, false),
  ...
  ('drink-2', 'Iced Tea', 'Refreshing iced tea with lemon', 2.99, 'https://images.unsplash.com/photo-1556679343-c1306ee5277b?w=500&q=80', 'drinks', true, true, true, false)
ON CONFLICT (id) DO NOTHING;
